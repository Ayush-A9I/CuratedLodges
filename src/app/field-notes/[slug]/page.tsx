...
import ArticleBody from '@/components/domain/ArticleBody';
      ...
      <>
        ...
        <main className={styles.main}>
          <div className={styles.notFound}>
            ...
            <Link href="/field-notes" className={styles.backLink}>
              ← Back to Field Notes
            </Link>
          </div>
        </main>
        ...
        <section className={styles.hero}>
          ...
          <div className={styles.heroContent}>
            ...
            <div className={styles.meta}>
              ...
              <time className={styles.date} dateTime={note.publishedDate}>
        ...
        {relatedNotes.length > 0 && (
          <section className={styles.relatedSection}>
            <div className={styles.relatedInner}>
              <h2 className={styles.relatedTitle}>More field notes</h2>
      ...
      {isShareModalOpen && (
        <div className={styles.shareModalOverlay} onClick={() => setIsShareModalOpen(false)}>
          <div className={styles.shareModalContent} onClick={(e) => e.stopPropagation()}>
            <button type="button" className={styles.shareModalClose} onClick={() => setIsShareModalOpen(false)} aria-label="Close">
              ×
            </button>
            <div className={styles.sharePreview}>
              <img src={note.image} alt={displayTitle} className={styles.sharePreviewImage} />
              <h3 className={styles.sharePreviewTitle}>{displayTitle}</h3>
            ...
            <div className={styles.shareActions}>
              ...
              <button
                ...
                className={styles.shareActionItem}
                onClick={() => {
                  const text = `Check out this field note: ${displayTitle}`;
