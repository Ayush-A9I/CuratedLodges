      ...
      <div className={styles.cardContainer}>
        <div className={styles.card}>
          ...
          <div className={styles.header}>
            ...
            <p className={styles.subtitle}>Begin your journey into the wild</p>
          </div>
          ...
          <div className={styles.socialButtons}>
            ...
            <button onClick={handleFacebookSignUp} className={styles.socialButton}>
              <svg className={styles.socialIcon} viewBox="0 0 24 24">
          ...
          <div className={styles.footer}>
            <p className={styles.footerText}>
              Already have an account? <Link href="/signin" className={styles.signinLink}>Sign in</Link>
            </p>
